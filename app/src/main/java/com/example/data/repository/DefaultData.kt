...
object DefaultData {
    fun getInitialHotspots(): List<HotspotEntity> = listOf(
        HotspotEntity(
            ...
            hindiName = "चांदीपुर बीच (लुप्त होता समुद्र)",
            category = "Beach",
        ...
        HotspotEntity(
            ...
            hindiName = "क्षीरचोरा गोपीनाथ मंदिर, रेमुणा",
            category = "Temple",
        ...
        HotspotEntity(
            ...
            hindiName = "पंचलिंगेश्वर मंदिर, नीलगिरि",
            category = "Temple",
        ...
        HotspotEntity(
            ...
            hindiName = "तालसारी समुद्र तट एवं सुवर्णरेखा मुहाना",
            category = "Beach",
        ...
        HotspotEntity(
            ...
            hindiName = "कुलडीहा वन्यजीव अभयारण्य",
            category = "Wildlife",
        ...
        HotspotEntity(
            ...
            hindiName = "बलरामगढ़ी मत्स्य बंदरगाह",
            category = "Port",
        ...
        HotspotEntity(
            ...
            hindiName = "मिसाइल परीक्षण केंद्र (ITR), चांदीपुर",
            category = "Heritage",
    ...
    fun getInitialWeatherAlerts(): List<com.example.data.model.BalasoreWeatherAlert> {
        ...
        return listOf(
            com.example.data.model.BalasoreWeatherAlert(
                ...
                hindiTitle = "उत्तर बंगाल की खाड़ी में गहरा दबाव: चांदीपुर एवं बलरामगढ़ी तट हेतु चेतावनी",
            ...
            com.example.data.model.BalasoreWeatherAlert(
                ...
                hindiTitle = "कालवैशाखी एवं वज्रपात चेतावनी (रेमुणा, बालेश्वर शहर, नीलगिरि)",
